...
![Version](https://img.shields.io/static/v1?label=Version&message=0.10.7&color=informational&style=flat-square) <!-- x-release-please-version -->
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
![AppVersion](https://img.shields.io/static/v1?label=AppVersion&message=0.10.7&color=informational&style=flat-square) <!-- x-release-please-version -->
...
| rwPublicationAdmission.enabled | bool | `false` | Install the fail-closed RW-publication ValidatingAdmissionPolicy and Deny binding. Required before any compatibility mover can run; the controller verifies the installed specs. Disabled by default to preserve existing installation scope. |
